...
namespace HHRROrganizer.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AppUser { OrganizationNumber = Input.OrganizationNumber, UserName = Input.Email, Email = Input.Email};
