...
//This function activates the functionality of the tooltips (help message) offered by bootstrap, for various buttons of the application.
...
document.querySelector('#randomGeneratorInput').addEventListener("click", function () {
    ...
    document.querySelector("#successfullyCreatedEmployee").innerHTML = "Employee picture created succesfully.";
